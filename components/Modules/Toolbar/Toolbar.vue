...
import ImportFile from '@components/Modules/Toolbar/Partials/ImportFile.vue';
...
<template>
  <nav
    class="flex items-center justify-between border-b-2 border-b-slate-300 bg-white px-4 py-2.5"
  >
